...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 text-left text-body-md font-medium text-text-primary transition-colors hover:text-primary-container [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
