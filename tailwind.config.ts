...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
      "display-lg": ["96px", { lineHeight: "1.05", letterSpacing: "-0.04em", fontWeight: "700" }],
      "display-lg-mobile": ["60px", { lineHeight: "1.05", letterSpacing: "-0.03em", fontWeight: "700" }],
      "headline-md": ["40px", { lineHeight: "1.15", letterSpacing: "-0.02em", fontWeight: "600" }],
